    ...
    GoogleDocsRenderer.prototype.parse = function (document) {
        ...
        if (document.content) {
            filteredStructuralElements =
                structuralElementFilter_1.structuralElementFilter(
                    document.content
                );
        }
        var filteredParagraphs = paragraphElementFilter_1.paragraphFilter(
            document.lists,
            filteredStructuralElements
        );
    ...
    Object.defineProperty(GoogleDocsRenderer.prototype, "html", {
        get: function () {
            ...
            var createLeaf = function (child) {
                if (child.hr) {
                    return (
                        '<hr class="gdr-leaf" data-gdr-leaf style="' +
                        createStyle(child.style) +
                        '" />'
                    );
                } else if (child.link) {
                    return (
                        '<a class="gdr-leaf" data-gdr-leaf href="' +
                        child.link.url +
                        '" style="' +
                        createStyle(child.style) +
                        '">' +
                    ...
                    return (
                        '<img class="gdr-leaf" data-gdr-leaf src="' +
                    ...
                    return (
                        '<b class="gdr-leaf" data-gdr-leaf><i class="gdr-leaf" data-gdr-leaf style="' +
                        createStyle(child.style) +
                        '">' +
                        child.text +
                        "</i></b>"
                    ...
                    return (
                        '<b class="gdr-leaf" data-gdr-leaf style="' +
                        createStyle(child.style) +
                        '">' +
                        child.text +
                        "</b>"
                    ...
                    return (
                        '<i class="gdr-leaf" data-gdr-leaf style="' +
                        createStyle(child.style) +
                        '">' +
                        child.text +
                        "</i>"
                    ...
                    return (
                        '<span class="gdr-leaf" data-gdr-leaf style="' +
                        createStyle(child.style) +
                        '">' +
                        child.text +
                        "</span>"
            ...
            var createNode = function (node) {
                ...
                if (node.type === "HEADING_1") {
                    return (
                        '<h1 class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</h1>"
                    ...
                    return (
                        '<h2 class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</h2>"
                    ...
                    return (
                        '<h3 class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</h3>"
                    ...
                    return (
                        '<h4 class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</h4>"
                    ...
                    return (
                        '<h5 class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</h5>"
                    ...
                    return (
                        '<h6 class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</h6>"
                    ...
                    return (
                        '<li class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</li>"
                    ...
                    return (
                        '<p class="gdr-node" data-gdr-node data-node-id="' +
                        node.id +
                        '">' +
                        children +
                        "</p>"
            ...
            var htmlString =
                '\n        <article class="gdr-document" data-gdr-document data-article-id="' +
                uuid_1.v4() +
                '">' +
                    ...
                    .map(function (elem) {
                        if (elem.type === "UNORDERED_LIST") {
                            var children = elem.children
                                ...
                                .join("");
                            return (
                                '<ul class="gdr-node" data-gdr-node data-gdr-list data-node-id="' +
                                elem.id +
                                '">' +
                                children +
                                "</ul>"
                            ...
                            var children = elem.children
                                ...
                                .join("");
                            return (
                                '<ol class="gdr-node" data-gdr-node data-gdr-list data-node-id="' +
                                elem.id +
                                '">' +
                                children +
                                "</ol>"
